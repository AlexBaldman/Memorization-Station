...
export default function Home () {
    ...
    return (
      <div class='home-content'>
        ...
        currently aware of, and yet we still are only just breaking the surface in terms of understanding the mechanisms of how it actually works.</p>
        <p>One of the most amazing things about the human brain is its ability to store and retrieve vast amounts of information.  One of the key insights
        ...
        we are to be able to recall that information quickly.  This seems to be seen most prominently with our sense of sight.</p>
        ...
        and that the milk kept spilling everywhere due to all the commotion!  
        ...
        in that outlandish situation as you had your cereal, you would be unlikely to forget it any time soon.  You might recall what you had had that day years later.
        </p>
        Most memory systems involve using these insights about the mind to build a "scaffolding" of sorts - a group known objects or locations
        with which to associate information to be memorized.  These are sometimes known as memory maps, journeys, palaces, etc.  
        </p>
